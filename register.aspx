...
<head runat="server">
    <meta charset="utf-8">
        ...
        <title>Hackfest - Register Page</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <div class="social-login d-flex flex-column w-50 m-auto">
                                ...
                                <a class="btn custom-btn social-btn mb-4">
                                    <i class="bi bi-google me-3"></i>

                                    Continue with Google
                                </a>

                                <a class="btn custom-btn social-btn">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form role="form" method="post">
                                        ...
                                        <p class="text-center">Already have an account? Please <a href="login.aspx">Sign In</a></p>
